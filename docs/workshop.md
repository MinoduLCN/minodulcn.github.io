...
[Activity booklet](https://github.com/MinoduLCN/minodulcn.github.io/blob/main/assets/pdf/Cahier_d'activit%C3%A9_Interface.pdf)
...
### Application Feedback Workshop 03/26
The application feedback workshop (03/26) follows a three-step methodology to capture how the Local Community Network (LCN) is perceived, understood, and evaluated.

The sticker set used across the following three activities is available here:
