...
| **Step 1:** Install the lcd module by pluging it into the pin header on the board and securing it with 2 screws | ![](../assets/images/tac_lcd.jpg) |
| **Step 2:** Plug the lcd module enable jumper in the "On" position  | ![](../assets/images/tac_lcd_jumper.jpg) |
| **Step 3:** Set the jumper on the Teleagriculture board to use USB power by setting the jumper on the USB position  | ![](../assets/images/tac_jumper_usb.jpg) |
...
| **Step 1:** Make sure the power jumper is set to the *SOL* power position. | ![](../assets/images/tac_power_jumper.jpg) |
| **Step 2:** Solder an angled two Pin header on the bottom of the Teleagriculture Board to the Pins labeled GND and 5V | ![](../assets/images/tac_pinheader.jpg) |
| **Step 2:** Connect a power cable between the soldered jumper and the raspberry PI header. The 5V cable should be connected to the PIN2 on the PI (That is the first pin in the outer row). The GND cable should be connected to PIN9 (That is the 5th pin in the inner row).  | ![](../assets/images/tac_power_cable.jpg) |
| **Step 3:** The display should show *Config Mode*. If it is not in config mode, press reset, then press the boot button for about 5 secs.  | ![](../assets/images/tac_config_mode.jpg) |
